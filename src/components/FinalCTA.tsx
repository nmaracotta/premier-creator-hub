          ...
          <Card className={cn(
            ...
            <CardContent className="p-10 md:p-14 relative">
              ...
              <div className="relative z-10">
                <Badge variant="outline" className="bg-white/10 text-white border-white/20 mb-6 uppercase tracking-wider text-xs">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10">
                  <Button 
                    size="lg" 
                    className="bg-white text-accent hover:bg-white/90 border-2 border-transparent transition-all duration-300 group shadow-lg shadow-accent/20 w-full sm:w-auto"
                    asChild
                  >
                    <a href="#contact">
