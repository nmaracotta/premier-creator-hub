...
const ClientNiches: React.FC = () => {
  return (
    <section id="niches" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <MotionWrapper animation="fade-in-up" delay={300}>
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <h2 className="h2 mb-6 text-3xl md:text-4xl lg:text-5xl">Already Helping Creators Like You</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 mb-16">
            {niches.map((niche, index) => (
              ...
              >
                ...
                <span className="font-medium text-lg text-center">{niche.label}</span>
