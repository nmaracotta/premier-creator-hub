...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-16 md:pt-24">
      ...
      <div className="container-custom relative z-10 py-8 md:py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <MotionWrapper animation="fade-in-up" delay={600}>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl mx-auto mb-6 md:mb-8 px-4">
